...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    title: "AI面接官が質問します",
    description: "AI面接官があなたの人柄やパーソナリティについて質問します。全部で7問、所要時間は約15〜30分です。リラックスしてお答えください。",
  },
  {
    icon: (
      <div className="w-16 h-16 bg-primary/8 rounded-3xl flex items-center justify-center">
...
function InterviewSessionContent() {
  ...
  }, [transcript, interimTranscript, stopListening, sendMessage]);
                ...
                <div className="flex items-center justify-center gap-3">
                  {!isListening ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button onClick={handleSendVoice} className="flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white font-semibold py-3 px-6 rounded-full transition-all duration-300">
